...
class MarkerStreamer:
    ...
    def _update_ui(self):
        ...
        for group_name, marker_group in self._marker_groups.items():
            ...
            for label in marker_group:
                ...
                icon = load_icon(os.path.dirname(os.path.abspath(__file__)) + '/assets/marker_64x32.png', marker_color)
    ...
    def group_markers(self):
        ...
        self._marker_groups[new_group_name] = self._marker_groups[new_group_name + ' temp']
