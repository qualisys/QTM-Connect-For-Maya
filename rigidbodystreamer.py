...
class RigidBodyStreamer:
    ...
    def _packet_received(self, packet):
        ...
        for i, body in enumerate(bodies):
            ...
            transform = self._bodies[i]['transform']
            ...
            if self._up_axis == 'y':
                ...
                translation = om.MVector(
                    body_position.x * self._unit_conversion,
                    body_position.y * self._unit_conversion,
                    bodu_position.z * self._unit_conversion
                )
                matrix = MMatrix([
                    rot[0], rot[1], rot[2], 0,
                    rot[3], rot[4], rot[5], 0,
    ...
    def _init(self):
        ...
        for i, body in enumerate(self._qtm_settings['The_6D']['Body']):
            body['Index'] = i
    ...
    def _update_ui(self):
        ...
        for body in self._bodies:
            icon = load_icon(os.path.dirname(os.path.abspath(__file__)) + '/assets/rigidbody.svg', QtGui.QColor(0x0, 0x0, 0x0))
